...
<!-- our-service section -->
<section class="career-highlight-section py-lg-5 py-4" data-aos="fade-up" data-aos-duration="900" data-aos-delay="100">
  <div class="container">
    <?php if($wh_title):?>
      <div class="row">
          <div class="col">
              <div class="title white center mb-lg-5 mb-4">
      ...
      <div class="col-lg-10 overflow-hidden">
        <div class="row justify-content-center">
          <div class="col-lg-6 col-md-8 col">
            <div class="career-highlight-carousel cw-nav">
