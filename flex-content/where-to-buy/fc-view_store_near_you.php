          ...
          <div class="col">
              <div class="d-flex links_ flex-wrap justify-content-center">
                <?php foreach($pn_tabs as $key=>$pntab):?>
                  <a href="<?= $pntab['pnt_tab_link']?>" <?php if($pntab['link_target']==true):?>target="_self"<?php else: ?>target="_blank"<?php endif; ?> class="<?php if($key==0):?>active<?php endif; ?>"><?= $pntab['pnt_tab_title']?></a>
                  <?php endforeach; ?>
              </div>
          </div>
      </div>
          ...
          <div class="col">
           <form action="" method="get" id="stockiesdataform">
              <div class="d-flex justify-content-center">
                  ...
                  <div class="select3 ml-3" id="countylist">
                      <select class="gui-select" name="county_ireland" id="county_ireland">
                        <option value=""  selected>Select County</option>
                        <?php foreach( $field_cnt_ir['choices'] as $ki => $v ) : ?>                        
                        <option value="<?php echo $ki; ?>" <?php if($county == $ki) { echo 'selected'; } ?>> <?php echo $v; ?></option>
                      <?php endforeach; ?>
                      </select>
                      <select class="gui-select" name="county_uk" id="county_uk">
                        <option value=""  selected>Select County</option>
                        <?php foreach( $field_cnt_uk['choices'] as $ku => $v ) : ?>
                         <option value="<?php echo $ku; ?>" <?php if($county == $ku) { echo 'selected'; } ?>> <?php echo $v; ?></option>
                        <?php endforeach; ?>
                      </select>
                      <select class="gui-select" name="county_none" id="county_none" >
                        <option value="" disabled selected>Select County</option>
                      </select>

                  </div>
                  <button type="submit" id="submit" class="lm-btn skew0">Search</button>
                  <button  id="reset1" class="lm-btn black skew0" href="/where-to-buy/view-stores-near-you/">Reset</button>
              </div>
              </form>
          </div>
      </div>
