...
if ( ! function_exists( 'foranequine_adjust_body_class' ) ) {
	 ...
	 */
	function foranequine_adjust_body_class( $classes ) {
...
if ( ! function_exists( 'foranequine_slbd_count_widgets' ) ) {
	/**
	 ...
	 * @deprecated 0.8.9
	 */
	function foranequine_slbd_count_widgets( $sidebar_id ) {
...
function deprecated_translations() {
	array(
		__( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'foranequine' ),
		__( 'Previous', 'foranequine' ),
		__( 'Next', 'foranequine' ),
		__( 'About:', 'foranequine' ),
		__( 'Profile', 'foranequine' ),
		__( 'Posts by', 'foranequine' ),
		__( 'Permanent Link:', 'foranequine' ),
		__( 'in', 'foranequine' ),
		__( 'Edit', 'foranequine' ),
	);
}
