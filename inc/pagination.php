...
if ( ! function_exists( 'foranequine_pagination' ) ) {
	/**
	 ...
	 */
	function foranequine_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'foranequine' ),
				'next_text'          => __( '&raquo;', 'foranequine' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'foranequine' ),
			)
		);
